...
public class Main {   
    ...
    libreria.visualizzaPila();

    System.out.println("Numero di libri di Mario Rossi: " + libreria.numLibriAutore("Mario", "Rossi"));
    
    System.out.println("Eliminati " + libreria.eliminaAutore("Mario", "Rossi") + " libri di Mario Rossi");
