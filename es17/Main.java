public class Main {
    public static void main(String[] args) {
        ...
        Quadro quadro1 = new Quadro("Notte Stellata", "Van Gogh", 150000, 73.7, 92.1);
        Quadro quadro2 = new Quadro("La Gioconda", "Leonardo da Vinci", 8500000, 77, 53);
        ...
        System.out.println("Quantità di quadri: " + collezione.quantitaOpere(Categoria.QUADRO));
        System.out.println("Quantità di sculture: " + collezione.quantitaOpere(Categoria.SCULTURA));
