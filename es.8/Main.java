public class Main {
    public static void main(String[] args) {
        ...
        Quadro quadro4 = new Quadro("JHK4", "Giovanna Perotta", 1944, "La mamma di zia di Perotta", 2);
        Quadro quadro5 = new Quadro("JHK4", "Leonardo Perotta", 1956, "La mamma di babbo di Perotta", 3);
